...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Users & Logs', path: '/admin/users', icon: 'M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2m8-8a4 4 0 100-8 4 4 0 000 8zm6-3a4 4 0 014 4v2' },
  ]
      ...
      <aside className="w-72 bg-white border-r border-gray-100 hidden md:flex flex-col fixed h-full">
        <div className="p-6 border-b border-gray-50">
          <Link to="/" className="flex items-center gap-2">
            <img src={assets.logo} alt="Pachheuri" className="h-7 w-auto object-contain" />
          </Link>
        </div>
