        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {images.map((img, idx) => (
              <label
                key={idx}
                className="relative aspect-square border-2 border-dashed border-gray-200 rounded-xl flex items-center justify-center cursor-pointer hover:border-neutral-900 transition-all overflow-hidden bg-gray-50"
              >
